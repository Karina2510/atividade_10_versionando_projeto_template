    ...
    <Card>
        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                <TableHead>
                <TableRow>
                    <TableCell style={{color: "red", fontWeight: 'bold'}}>Prioridade</TableCell>
                    <TableCell style={{color: "red", fontWeight: 'bold'}}>Título</TableCell>
                    <TableCell align="right" style={{color: "red", fontWeight: 'bold'}}>Descrição</TableCell>
                    <TableCell align="right" style={{color: "red", fontWeight: 'bold'}}>Data de Início</TableCell>
                    <TableCell align="right" style={{color: "red", fontWeight: 'bold'}}>Data de Finalização</TableCell>
                    <TableCell align="right" style={{color: "red", fontWeight: 'bold'}}>Status</TableCell>
                    <TableCell align="right" style={{color: "red", fontWeight: 'bold'}} >Recurso</TableCell>
